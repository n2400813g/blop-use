...
async def validate_setup(
    ...
    if api_key:
        checks.append({"name": "GOOGLE_API_KEY", "passed": True, "message": "Set and non-empty"})
    else:
        checks.append({"name": "GOOGLE_API_KEY", "passed": False, "message": "Not set — required for Gemini agent and flow planning"})
        blockers.append("GOOGLE_API_KEY environment variable is not set")
